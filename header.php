...
<div id="sidebar">
    <ul>
        ...
        <li class="submenu"><a href="#"><i class="icon icon-th-list"></i> <span>Speakers</span> <span
                class="label label-important">2</span></a>
            <ul>
                <li><a href="add_new_speakers.php">Add New Speakers (admin view)</a></li>
                <li><a href="speakers.php">Speakers (user view)</a></li>
            </ul>
        </li>
